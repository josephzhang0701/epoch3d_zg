...
#include "triangle/b_part.inc"
  ...
  SUBROUTINE generate_photon(generating_electron, iphoton, eta)
    ...
    generating_electron%particle_radt = generating_electron%particle_radt + photon_energy ! Gong
    generating_electron%particle_radn = generating_electron%particle_radn + 1.0_num ! Gong
