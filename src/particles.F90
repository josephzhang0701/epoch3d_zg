...
#include "triangle/b_part.inc"
        ...
        END IF
#ifdef PART_FIELD
        current%part_ex = ex_part*fac ! Z. Gong in April 2020
        current%part_ey = ey_part*fac ! Z. Gong
        current%part_ez = ez_part*fac ! Z. Gong
        current%part_bx = bx_part*fac ! Z. Gong
        current%part_by = by_part*fac ! Z. Gong
        current%part_bz = bz_part*fac ! Z. Gong
#endif
