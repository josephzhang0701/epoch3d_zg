  ...
  SUBROUTINE output_routines(step, force_write)   ! step = step index
    ...
    DO iprefix = 1,SIZE(file_prefixes)
      ...
      DO isubset = 1, n_subsets + 1
        ...
        CALL write_particle_variable(c_dump_part_eta, code, &   ! Gong
            'particle_eta', '', it_output_real)
        CALL write_particle_variable(c_dump_part_radn, code, &
            'particle_radn', '', it_output_real)
        CALL write_particle_variable(c_dump_part_radt, code, &
            'particle_radt', '', it_output_real)
#endif
...
#endif
#ifdef PART_FIELD
        CALL write_particle_variable(c_dump_part_ex, code, & ! Z. Gong in April 2020
            'Part_ex', 'V', it_output_real)
        CALL write_particle_variable(c_dump_part_ey, code, & ! Z. Gong in April 2020
            'Part_ey', 'V', it_output_real)
        CALL write_particle_variable(c_dump_part_ez, code, & ! Z. Gong in April 2020
            'Part_ez', 'V', it_output_real)
        CALL write_particle_variable(c_dump_part_bx, code, & ! Z. Gong in April 2020
            'Part_bx', 'T', it_output_real)
        CALL write_particle_variable(c_dump_part_by, code, & ! Z. Gong in April 2020
            'Part_by', 'T', it_output_real)
        CALL write_particle_variable(c_dump_part_bz, code, & ! Z. Gong in April 2020
            'Part_bz', 'T', it_output_real)
#endif
