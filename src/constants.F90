...
MODULE constants
  ...
  INTEGER(i8), PARAMETER :: c_def_part_field = 2**28 ! Z. Gong
  ...
  INTEGER, PARAMETER :: c_dump_cou_log           = 73
    INTEGER, PARAMETER :: c_dump_part_ex           = 74  ! Z.Gong
  INTEGER, PARAMETER :: c_dump_part_ey           = 75
  INTEGER, PARAMETER :: c_dump_part_ez           = 76
  INTEGER, PARAMETER :: c_dump_part_bx           = 77  ! Z.Gong
  INTEGER, PARAMETER :: c_dump_part_by           = 78
  INTEGER, PARAMETER :: c_dump_part_bz           = 79
  INTEGER, PARAMETER :: c_dump_part_eta          = 80  ! Z.Gong
  INTEGER, PARAMETER :: c_dump_part_radn         = 81  ! Z.Gong
  INTEGER, PARAMETER :: c_dump_part_radt         = 82  ! Z.Gong
